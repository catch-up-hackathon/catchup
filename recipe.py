...
completion = openai.ChatCompletion.create(
  model="gpt-3.5-turbo",
  messages=[{"role": "system", "content": "You are a cooking expert bot who can revise recipes for individuals."},
        {"role": "user", "content": f"Arrange the list of recipe from following context, replace the ingredients and revise the recipe for good taste. \
